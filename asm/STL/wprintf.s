...
.section .text, "ax"
# NOTE:
# Actually parse_format, but it is not global (printf.o/scanf.o has another implementation of it)
# I had to make this global because of its extab entry, so I've changed the name to prevent conflict with printf.o/scanf.o's version
.global parse_format_wprintf
parse_format_wprintf:
...
# Locally defined to avoid conflict with printf.o
long2str:
...
# Locally is "longlong2str"
# Had to define it as global for extab, so it has a name change to avoid conflict with printf.o
.global longlong2str_wprintf
longlong2str_wprintf:
...
# Name changed (see longlong2str_wprintf)
.global double2hex_wprintf
double2hex_wprintf:
...
/* 800BBA14 000B6914  4B FF F8 F1 */	bl long2str
...
# Defined locally to avoid conflict with printf.o
round_decimal:
...
/* 800BBFF8 000B6EF8  4B FF FB B5 */	bl round_decimal
lbl_800BBFFC:
...
/* 800BC0B4 000B6FB4  4B FF FA F9 */	bl round_decimal
lbl_800BC0B8:
...
/* 800BC234 000B7134  4B FF F9 79 */	bl round_decimal
...
/* 800BC558 000B7458  4B FF E7 ED */	bl parse_format_wprintf
...
/* 800BC728 000B7628  4B FF EE 11 */	bl longlong2str_wprintf
...
/* 800BC768 000B7668  4B FF EB 9D */	bl long2str
...
/* 800BC884 000B7784  4B FF EC B5 */	bl longlong2str_wprintf
...
/* 800BC8C4 000B77C4  4B FF EA 41 */	bl long2str
...
/* 800BC940 000B7840  4B FF F3 95 */	bl float2str_wprintf
...
/* 800BC9BC 000B78BC  4B FF EE 29 */	bl double2hex_wprintf
